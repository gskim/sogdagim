...
export class init1586966200084 implements MigrationInterface {
    name = 'init1586966200084'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `nickname` varchar(30) NOT NULL, `email` varchar(200) NOT NULL, `verified` tinyint NOT NULL DEFAULT 0, `gender` enum ('m', 'w') NULL, `birth_year` int NULL, `birth_month` int NULL, `birth_day` int NULL, `password` text NULL, `profile_photo` text NULL, `lat` float(12) NOT NULL DEFAULT 0, `lon` float(12) NOT NULL DEFAULT 0, `sns_id` int NULL, `sns_type` varchar(10) NULL, `point` int NOT NULL DEFAULT 0, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
