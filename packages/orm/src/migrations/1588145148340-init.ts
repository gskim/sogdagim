...
export class init1588145148340 implements MigrationInterface {
    name = 'init1588145148340'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `nickname` varchar(30) NOT NULL COMMENT '닉네임', `email` varchar(200) NOT NULL, `verified` tinyint NOT NULL DEFAULT 0, `access_token` varchar(100) NULL COMMENT '로그인시 업데이트되는 토큰', `gender` enum ('m', 'w') NOT NULL DEFAULT 'm', `birth_year` varchar(4) NOT NULL, `birth_month` varchar(2) NOT NULL, `birth_day` varchar(2) NOT NULL, `password` varchar(300) NOT NULL, `profile_photo` text NULL, `lat` float(12) NOT NULL DEFAULT 0, `lon` float(12) NOT NULL DEFAULT 0, `point` int NOT NULL DEFAULT 0, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
