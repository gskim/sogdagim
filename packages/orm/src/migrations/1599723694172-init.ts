...
export class init1599723694172 implements MigrationInterface {
    name = 'init1599723694172'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `device` (`id` int NOT NULL AUTO_INCREMENT, `fcm_token` varchar(255) NULL, `uuid` varchar(36) NOT NULL, `is_device` tinyint NOT NULL, `brand` varchar(20) NULL, `manufacturer` varchar(20) NULL, `model_name` varchar(20) NULL, `model_id` varchar(20) NULL, `design_name` varchar(20) NULL, `product_name` varchar(20) NULL, `device_year_class` varchar(20) NULL, `supported_cpu_architectures` varchar(50) NULL, `os_name` varchar(20) NOT NULL, `os_version` varchar(20) NOT NULL, `os_build_id` varchar(20) NULL, `os_internal_build_id` varchar(20) NULL, `os_build_fingerprint` varchar(300) NULL, `platform_api_level` int NULL, `device_name` varchar(100) NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `user_id` int NULL, INDEX `IDX_0683d0c6ce6c0327208a026da5` (`uuid`), UNIQUE INDEX `uuid` (`uuid`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `nickname` varchar(30) NOT NULL COMMENT '닉네임', `email` varchar(200) NOT NULL, `sign_up_type` enum ('email', 'google', 'apple') NOT NULL DEFAULT 'email', `access_token` varchar(100) NULL COMMENT '로그인시 업데이트되는 토큰', `gender` enum ('m', 'w') NOT NULL DEFAULT 'm', `birth_year` varchar(4) NULL, `birth_month` varchar(2) NULL, `birth_day` varchar(2) NULL, `password` varchar(300) NULL, `profile_photo` text NULL, `lat` float(12) NOT NULL DEFAULT 0, `lon` float(12) NOT NULL DEFAULT 0, `point` int NOT NULL DEFAULT 0, `oauth_id` varchar(100) NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `message` (`id` int NOT NULL AUTO_INCREMENT, `text` text NOT NULL, `is_image` tinyint NOT NULL DEFAULT 0, `is_read` tinyint NOT NULL DEFAULT 0, `order_id` int NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `chat_id` int NULL, `user_id` int NULL, UNIQUE INDEX `IDX_a249d6abd5b2dacca134cfea12` (`order_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `chat` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NULL, `description` varchar(255) NULL, `max_persons` int NOT NULL DEFAULT 2, `password` varchar(255) NULL, `type` enum ('public', 'private', 'friend', 'random', 'close') NOT NULL DEFAULT 'random', `expiration_date` datetime NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `chat_queue` (`id` int NOT NULL AUTO_INCREMENT, `type` enum ('match', 'ready', 'out') NOT NULL DEFAULT 'ready', `user_id` int NOT NULL, `socket_id` varchar(255) NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), INDEX `IDX_7c2083c235503359ed874e06f0` (`user_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
